...
public class ShipmentDimensionDto implements Serializable {
    ...
    /**
     * Attribute holds <code>Allow package to be rotated to fit in door </code> property.
     */
     ...
     * <p>
     * 
     * @return <code>{@link com.unisys.trans.logistics.lms.framework.dto.ShipmentPieceDimensionsDto
    ...
    public List<ShipmentPieceDimensionsDto> getShipmentPieceDimensions() {
    	if(this.shipmentPieceDimensions==null) {
    		this.shipmentPieceDimensions = new ArrayList<ShipmentPieceDimensionsDto>();	
    	}
    ...
    /**
     * Gets the <code>allowPackage</code> property.
     * <p>
     * Whether to be rotated or not to fit in the door.
     * <p>
     * <b>Format:</b><br>
     * boolean.
     * <p>
     * 
     * @return the current value of the <code>allowPackage</code> property.
     */
    ...
    /**
     * Sets the <code>allowPackage</code> property.
     * <p>
     * Package to be rotated or not to fit in the door.
     * <p>
     * <b>Format:</b><br>
     * boolean
     * <p>
     * 
     * @param pAnallowPackage the new value of the AllowPackage<code></code> property.
     */
    public void setAllowPackage(final boolean pAnallowPackage) {
        this.allowPackage = pAnallowPackage;
    }
     ...
     *            {@link com.unisys.trans.logistics.lms.framework.dto.ShipmentPieceDimensionsDto
     *            ShipmentPieceDimensionsDto}</code><br>
     ...
     */
    public boolean isMinimalVolume() {
        return this.minimalVolume;
    }

    /**
     * @param minimalVolume
     *            the minimalVolume to set
     */
    public void setMinimalVolume(final boolean pMinimalVolume) {
        this.minimalVolume = pMinimalVolume;
    }
     ...
     */
    public void setMinimumVolume(BigDecimal pMinimumVolume) {
        this.minimumVolume = pMinimumVolume;
    }

    /**
     * Attribute holds <code>minimalVolume</code> property.
     */
    private boolean minimalVolume;

    /**
     * Attribute holds <code>minimumVolume</code> property.
     */
