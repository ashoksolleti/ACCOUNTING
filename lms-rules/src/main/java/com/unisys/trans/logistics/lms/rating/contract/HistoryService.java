...
import com.unisys.trans.logistics.lms.utils.dto.HistoryDeleteRequest;
import com.unisys.trans.logistics.lms.utils.dto.HistoryFindRequest;
import com.unisys.trans.logistics.lms.utils.dto.HistoryPersistRequest;
import com.unisys.trans.logistics.lms.utils.dto.HistoryResponse;

/**
 * <code>HistoryService</code> interface exposes the APIs which identifies various processing flows involved
 ...
 * <p>
 * 
 * @see com.unisys.trans.logistics.lms.utils.dto.HistoryFindRequest
 * @see com.unisys.trans.logistics.lms.utils.dto.HistoryPersistRequest
 * @see com.unisys.trans.logistics.lms.utils.dto.HistoryResponse
 */
...
public interface HistoryService {
     ...
     *             type.
     */
    void createHistory(HistoryPersistRequest pHistoryPersistRequest) throws LMSException;
     ...
     */
    HistoryResponse findHistory(HistoryFindRequest pHistoryFindRequest) throws LMSException;

    BatchResponse assemblePersistenceDto(final BatchRequest pBatchRequest) throws LMSException;

    HistoryResponse deleteAllHardDeleteHistory(final HistoryDeleteRequest aHistoryDeleteRequest)throws LMSException;
