...
/**
 * <code>AccountingTotalChargesDto</code> contains the details of AccountingTotalChargesDto.
 * <p>
 * This contains all information about AccountingTotalChargesDto.
 * <p>
...
public class AccountingTotalChargesDto implements Serializable {
    ...
    /**
     * Attribute to hold <code>weightTaxInd</code> property.
     */
    private String weightTaxInd;
    
    /**
     * Attribute to hold <code>valuationTaxInd</code> property.
     */
    private String valuationTaxInd;
	...
	public String getWeightTaxInd() {
		return weightTaxInd;
	}

	public void setWeightTaxInd(String weightTaxInd) {
		this.weightTaxInd = weightTaxInd;
	}

	public String getValuationTaxInd() {
		return valuationTaxInd;
	}

	public void setValuationTaxInd(String valuationTaxInd) {
		this.valuationTaxInd = valuationTaxInd;
	}
}
