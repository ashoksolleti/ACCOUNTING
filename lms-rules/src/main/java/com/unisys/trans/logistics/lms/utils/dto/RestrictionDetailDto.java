...
public class RestrictionDetailDto implements Serializable {
    ...
    private List<com.unisys.trans.logistics.lms.framework.preferences.RestrictionCodeDto> restrictionCodes1;
    /**
    ...
    public List<com.unisys.trans.logistics.lms.framework.preferences.RestrictionCodeDto> getRestrictionCodes1() {
        return restrictionCodes1;
    }

    public void setRestrictionCodes1(List<com.unisys.trans.logistics.lms.framework.preferences.RestrictionCodeDto> restrictionCodes1) {
        this.restrictionCodes1 = restrictionCodes1;
    }
}
