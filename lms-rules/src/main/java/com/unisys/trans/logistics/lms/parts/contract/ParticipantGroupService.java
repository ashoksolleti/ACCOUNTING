...
import com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto;
 ...
 * </ul>
 * 
 * @see com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDeleteRequest
 * @see com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupFindRequest
 * @see com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupPersistRequest
 * @see com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupRestoreRequest
...
public interface ParticipantGroupService {
     ...
     * <p>
     * 
     * @param pParticipantGroupPersistRequest
     *            <code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantPersistRequest
     *            ParticipantPersistRequest}</code><br>
     *            <li><code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto
     *            ParticipantGroupDto} - (M)</code>
     *            <ul>
     *            <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto#setGroupDescription
     *            groupDescription} - (M)</code> <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto#setGroupNumber
     *            groupNumber} - (M)</code> <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto#setOId
     *            oId} - (C)</code><br>
     *            Prohibited for create operation,othrwise mandatory. <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto#setGroupMembers
     ...
     *            </ul>
     *            </ul>
     * @return <code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupResponse
     *         ParticipantGroupResponse}</code><br>
     *         <ul>
     *         <li><code> {@link com.unisys.trans.logistics.lms.framework.dto.AbstractResponse
     *         Response fields} </code> <li><code>
     *         {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto
     *         participantGroups}(1:*) </code>
     *         <ul>
     *         <li><code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto
     *         ParticipantGroupDto} </code>
     *         </ul>
     *         <li><code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantDetailDto
     ...
     */
    ParticipantGroupResponse createParticipantGroup(
     ...
     * </table>
     * 
     * @param pParticipantGroupDeleteRequest
     ...
     *            <ul>
     *            <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDeleteRequest#setEndDate
     *            endDate} - (M)</code> <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDeleteRequest#setGroupNumber
     *            groupNumber} - (M)</code> <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDeleteRequest#setOId
     *            oId} - (M)</code>
     *            </ul>
     * @return <code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupResponse
     *         ParticipantGroupResponse}</code><br>
     ...
     */
    ParticipantGroupResponse deleteParticipantGroup(
     ...
     * </table>
     * 
     * @param pParticipantGroupFindRequest
     *            <code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupFindRequest
     *            ParticipantGroupFindRequest}</code><br>
     *            holds the attributes to find the <code>ParticipantGroup</code> .<br>
     *            <ul>
     *            <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupFindRequest#setGroupNumber
     *            groupNumber} - (M)</code> <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupFindRequest#setRetrieveType
     *            retrieveType} - (C)</code><br>
     *            Retrieve type is "G" when Participant group is retrieved by group number. <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupFindRequest#setExactMatchIndicator
     *            exactMatchIndicator} - (C)</code><br>
     *            True - if user wants to retrieve a particular group.<br>
     *            False - Retrieve all groups. <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupFindRequest#setParticipantAccountNumber
     *            participantAccountNumber} - (P)</code> <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupFindRequest#setParticipantAccountType
     ...
     *         <li><code> {@link com.unisys.trans.logistics.lms.framework.dto.AbstractResponse
     *         Response fields} </code> <li><code>
     *         {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupResponse#getParticipantGroups()
     *         participantGroups}(1:*) </code>
     *         <ul>
     *         <li><code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto
     *         ParticipantGroupDto} </code>
     ...
     *             readable message and message type.
     */
    ParticipantGroupResponse findParticipantGroupByGroupNumber(
     ...
     * @return <code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto
     *         ParticipantGroupDto}</code>
     * @throws LMSException
     *             If validation fails the above mentioned error codes are
     *             returned. Each CodeMessage contains the status code,human
     *             readable message and message type.
     */
    List<ParticipantGroupDto> findParticipantGroupsByGroupNumbers(
     ...
     *             readable message and message type.
     */
    ParticipantGroupResponse findParticipantGroupsForParticipant(
                ParticipantGroupFindRequest pParticipantGroupFindRequest)
                throws LMSException;
     ...
     * </table>
     * 
     * @param pParticipantGroupRestoreRequest
     *            <code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupRestoreRequest
     *            ParticipantGroupRestoreRequest}</code><br>
     *            holds attributes to reactivate a participant.<br>
     *            <ul>
     *            <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupRestoreRequest#setGroupNumber
     *            groupNumber} - (M)</code> <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupRestoreRequest#setOId
     *            oId} - (M)</code>
     *            </ul>
     * @return <code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupResponse
     *         ParticipantGroupResponse}</code><br>
     ...
     *             readable message and message type.
     */
    ParticipantGroupResponse restoreParticipantGroup(
     ...
     *            oId} - (O)</code><br>
     *            <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto#setDeleteIndicator
     *            deleteIndicator} - (P)</code><br>
     *            <li><code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto#setEndDate
     *            endDate} - (P)</code><br>
     *            <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDto#setGroupMembers
     ...
     *             the status code,human readable message and message type.
     */
    ParticipantGroupResponse updateParticipantGroup(
                ParticipantGroupPersistRequest pParticipantGroupPersistRequest)
                throws LMSException;
     ...
     * 
     * @param pParticipantGroupDeleteRequest
     *            <code> {@link com.unisys.trans.logistics.lms.parts.dto.ParticipantGroupDeleteRequest
     *            ParticipantGroupDeleteRequest}</code><br>
     *            holds the attributes to find the <code>Participant</code>.
     *            <ul>
     *            <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.pParticipantGroupDeleteRequest#setEndDate
     *            endDate} - (M)</code> <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.pParticipantGroupDeleteRequest#setGroupNumber
     *            groupNumber} - (M)</code> <li><code>
     *            {@link com.unisys.trans.logistics.lms.parts.dto.pParticipantGroupDeleteRequest#setGroupNumber
     *            version} - (C)</code>
     *            </ul>
    ...
    BatchResponse findParticipantByGroupNumbers(
                ParticipantGroupDeleteRequest pParticipantGroupDeleteRequest) throws LMSException;
	...
	ParticipantGroupResponse findParticipantGroupByGroupAccNuber(
			ParticipantGroupFindRequest pParticipantGroupFindRequest)throws LMSException;
	
	ParticipantGroupResponse findParticipantGroupByUpdatedDate(ParticipantGroupFindRequest pParticipantGroupFindRequest) throws LMSException;
//X
	ParticipantGroupResponse findAllParticipant(ParticipantGroupFindRequest aParticipantGroupFindRequest) throws LMSException;
