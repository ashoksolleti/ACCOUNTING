 ...
 * </ul>
 */
public class RestrictTypeDto extends PersistenceObjectDto {
    /**
     ...
     */
    private List<RestrictionCodeDto> restrictionDetails;
     ...
     *            <p>
     */
    public RestrictTypeDto(final Long pOId, final long pVersion) {
        this.oId = pOId;
