 ...
 * </ul>
 */
public class BillingGroupPersistRequest extends AbstractRequest {
	/**
     ...
     */
    public BillingGroupPersistRequest() {
     ...
     */
    public BillingGroupDto getParticipantGroup() {
     ...
     */
    public void setParticipantGroup(final BillingGroupDto pBillingGroup) {
