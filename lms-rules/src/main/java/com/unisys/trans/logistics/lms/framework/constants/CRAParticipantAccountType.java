...
public enum CRAParticipantAccountType {
     ...
     */
    CRAParticipantAccountType(final String pParticipantAccountType) {
     ...
     *            -account type
     */
    private CRAParticipantAccountType(final String pParticipantAccountType, final String pLabel) {
        this.setStringValue(pParticipantAccountType);
     ...
     */
    public static CRAParticipantAccountType getCRAParticipantAccountType(
                final String pCRAParticipantAccountType) {

        CRAParticipantAccountType aCRAParticipantAccountType = null;

        for (final CRAParticipantAccountType aType : CRAParticipantAccountType.values()) {

            if (pCRAParticipantAccountType.equalsIgnoreCase(aType.getStringValue())) {
