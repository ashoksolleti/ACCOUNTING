...
import com.unisys.trans.logistics.lms.framework.constants.RateClassType;
...
public class RatingLineRulesDto extends PersistenceObjectDto {
	/**
     * 
     */
	...
	//FIS142B Changes starts
		...
		private int ratePerKilo;
		
		public BigDecimal getOverPivotWeight() {
			return overPivotWeight;
		}

		public void setOverPivotWeight(BigDecimal overPivotWeight) {
			this.overPivotWeight = overPivotWeight;
		}
		...
		public void setUldDiscount(BigDecimal uldDiscount) {
			this.uldDiscount = uldDiscount;
		}

		public int getRatePerKilo() {
			return ratePerKilo;
		}

		public void setRatePerKilo(int ratePerKilo) {
			this.ratePerKilo = ratePerKilo;
		}
		
		//FIS142B Changes ends
